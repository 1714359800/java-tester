...
if __name__ == '__main__':
    ...
    request.llm_config.api_key = "sk-573ab2d3d0c4452cb7cb190d130bd1e0"
    request.cache_key = "123123"
    request.dataset_name = "commons-cli"
    request.dataset_start_index = 1
    request.dataset_size = 1
